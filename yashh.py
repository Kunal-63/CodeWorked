...
def GR_FUNCTION(DatabaseName):
    ...
    MAIN_FRAME_0=Frame(MAIN_FRAME,relief=RIDGE,bg="lightgrey",height=750,width=1500
                       ,borderwidth=4)
    ...
    def gr_details():
        ...
        MAIN_FRAME_0.configure(bg="lightgrey")

        # photo_frame = Frame(MAIN_FRAME_0,height=125,width=125,borderwidth=4,relief=RIDGE)
        # photo_frame.place(x=30,y=20)
        
        details_frame=Frame(MAIN_FRAME_0,height=170,width=1400,bg="lightgrey",borderwidth=4,relief=RIDGE)
        details_frame.place(x=30,y=20)

        GAP = 50
        
        general_details_frame=Frame(MAIN_FRAME_0,height=400,width=1400,bg="lightgrey",borderwidth=4,relief=RIDGE)
        general_details_frame.place(x=30,y=200)

        gr_lbl=Label(details_frame,text="GR NO :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        gr_lbl.place(x=30,y=20)
        gr_var=IntVar()
        gr_ent=Entry(details_frame,textvariable=gr_var,font=("Arial",12,"bold"))
        gr_ent.place(x=120,y=25)
        ...
        form_no_lbl=Label(details_frame,text="Form No :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        form_no_lbl.place(x=310 + GAP ,y=20)
        form_no_var=IntVar()
        form_no_ent=Entry(details_frame,textvariable=form_no_var,font=("Arial",12,"bold"))
        form_no_ent.place(x=400 + GAP ,y=25)            

        enquiry_no_lbl=Label(details_frame,text="Enquiry No :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        enquiry_no_lbl.place(x=600 + GAP ,y=20)
        enquiry_no_var=IntVar()
        enquiry_no_ent=Entry(details_frame,textvariable=enquiry_no_var,font=("Arial",12,"bold"))
        enquiry_no_ent.place(x=730 + GAP ,y=25) 

        uid_lbl=Label(details_frame,text="UID :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        uid_lbl.place(x=950 + GAP ,y=20)
        uid_var=IntVar()
        uid_ent=Entry(details_frame,textvariable=uid_var,font=("Arial",12,"bold"))
        uid_ent.place(x=1040 + GAP ,y=25) 

        name1_lbl=Label(details_frame,text="Name :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        name1_lbl.place(x=30,y=100)

        surname_lbl=Label(details_frame,text="Surname:",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        surname_lbl.place(x=120,y=68)
        surname_var=StringVar()
        surname_ent=Entry(details_frame,text=surname_var,font=("Arial",12,"bold"))
        surname_ent.place(x=120,y=105)

        name_lbl=Label(details_frame,text="Name:",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        name_lbl.place(x=400 + GAP,y=68)
        name_var=StringVar()
        name_ent=Entry(details_frame,text=name_var,font=("Arial",12,"bold"))
        name_ent.place(x=400 + GAP,y=105)

        father_lbl=Label(details_frame,text="Father:",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        father_lbl.place(x=730 + GAP,y=68)
        father_var=StringVar()
        father_ent=Entry(details_frame,text=father_var,font=("Arial",12,"bold"))
        father_ent.place(x=730 + GAP,y=105)

        mother_lbl=Label(details_frame,text="Mother:",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        mother_lbl.place(x=1040 + GAP,y=68)
        mother_var=StringVar()
        mother_ent=Entry(details_frame,text=mother_var,font=("Arial",12,"bold"))
        mother_ent.place(x=1040 + GAP,y=105)


        sex_lbl=Label(general_details_frame,text="Sex :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        sex_lbl.place(x=30,y=20)
        sex_var= StringVar()
        sex_combo = ttk.Combobox(general_details_frame,width=20,textvariable = sex_var,font=("Arial",12,"bold"))
        sex_combo['values'] = ('Male','Female')
        sex_combo.place(x=120,y=25)

        birth_date_lbl=Label(general_details_frame,text="Birth Date :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        birth_date_lbl.place(x=310 + GAP,y=20)
        birth_date_ent=DateEntry(general_details_frame,selectmode="day",date_pattern="dd-mm-y",width=17,font=("Arial",12,"bold"))
        birth_date_ent.place(x=400 + 50 + GAP,y=25)

        category_lbl=Label(general_details_frame,text="Category :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        category_lbl.place(x=730 + GAP,y=20)
        category_var=StringVar()
        category_combo = ttk.Combobox(general_details_frame,width=17,textvariable = category_var,font=("Arial",12,"bold"))
        category_combo['values'] = ('SEBC','ST','GEN','SC')
        category_combo.place(x=820  + 70 + GAP,y=25)

        religion_lbl=Label(general_details_frame,text="Religion :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        religion_lbl.place(x=30,y=80)
        religion_var=StringVar()
        religion_combo = ttk.Combobox(general_details_frame,width=20,textvariable = religion_var,font=("Arial",12,"bold"))
        religion_combo['values'] = ('Hindhu','Muslim','Jain','Sikh','Cristian')
        religion_combo.place(x=120,y=85)

        birth_place_lbl=Label(general_details_frame,text="Birth Place :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        birth_place_lbl.place(x=310 + GAP,y=80)
        birth_place_var=StringVar()
        birth_place_ent=Entry(general_details_frame,text=birth_place_var,font=("Arial",12,"bold"))
        birth_place_ent.place(x=400 + 50 + GAP,y=85)

        
        previous_school_lbl=Label(general_details_frame,text="Previous School :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        previous_school_lbl.place(x=730 + GAP,y=80)
        previous_school_var=StringVar()
        previous_school_ent=Entry(general_details_frame,text=previous_school_var,font=("Arial",12,"bold"))
        previous_school_ent.place(x=820 + 70 + GAP,y=85)

        caste_lbl=Label(general_details_frame,text="Caste :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        caste_lbl.place(x=30,y=110)
        caste_var=StringVar()
        caste_combo = ttk.Combobox(general_details_frame,textvariable = caste_var,font=("Arial",12,"bold"))
        caste_combo['values'] = ('Hindhu','Muslim','Jain','Sikh','Cristian')
        caste_combo.place(x=120,y=115)

        birth_taluka_lbl=Label(general_details_frame,text="Birth Taluka :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        birth_taluka_lbl.place(x=310 + GAP,y=110)
        birth_taluka_var=StringVar()
        birth_taluka_ent=Entry(general_details_frame,text=birth_taluka_var,font=("Arial",12,"bold"))
        birth_taluka_ent.place(x=400 + 50 + GAP,y=115)

        subcaste_lbl=Label(general_details_frame,text="Subcaste :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        subcaste_lbl.place(x=30,y=160)
        subcaste_var=StringVar()
        subcaste_combo = ttk.Combobox(general_details_frame,width=20,textvariable = subcaste_var,font=("Arial",12,"bold"))
        subcaste_combo['values'] = ('Hindhu','Muslim','Jain','Sikh','Cristian')
        subcaste_combo.place(x=120,y=165)

        state_lbl=Label(general_details_frame,text="State :",padx=5,pady=5,bg="lightgrey",font=("Arial",12,"bold"))
        state_lbl.place(x=310 + GAP,y=160)
        state_var=StringVar()
        state_ent=Entry(general_details_frame,text=state_var,font=("Arial",12,"bold"))
        state_ent.place(x=400 + 50 + GAP,y=165)

        minorityvalue=IntVar()
        minority_check=Checkbutton(general_details_frame,text="Minority",onvalue=1,offvalue=0,bg="lightgrey",activebackground="black")
        minority_check.place(x=100,y=225)

        rtevalue=IntVar()
        rte_check=Checkbutton(general_details_frame,text="RTE",variable=rtevalue,onvalue=1,offvalue=0,bg="lightgrey",activebackground="black")
    ...
    def academic_details():
        ...
        academic_frame1=Frame(MAIN_FRAME_0,height=461,width=560,bg="lightgrey",borderwidth=4,relief=RIDGE)
        academic_frame1.place(x=0,y=0)

        #
        Gr_label = Label(academic_frame1, text="GR NO : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Name_label = Label(academic_frame1, text="Name : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        activevalue=IntVar()
        active_check=Checkbutton(academic_frame1,text="Active",variable=activevalue,offvalue=0,onvalue=1,activebackground="lightgrey",font=("Arieal",10,"bold"),bg="lightgrey")
        active_check.place(x=65,y=80)

        leftvalue=IntVar()
        left_check=Checkbutton(academic_frame1,text="Left",variable=leftvalue,offvalue=0,onvalue=1,activebackground="lightgrey",font=("Arieal",10,"bold"),bg="lightgrey")
        left_check.place(x=190,y=80)

        aaivalue=IntVar()
        aai_check=Checkbutton(academic_frame1,text="AAI",variable=aaivalue,offvalue=0,onvalue=1,activebackground="lightgrey",font=("Arieal",10,"bold"),bg="lightgrey")
        aai_check.place(x=315,y=80)
        #
        in_active_date_lbl=Label(academic_frame1,text="InActive Date :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        date_lbl=Label(academic_frame1,text="Date",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        date_lbl.place(x=170,y=160)

        year_lbl=Label(academic_frame1,text="Year",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        year_lbl.place(x=270,y=160)

        standard=Label(academic_frame1,text="Standard",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        standard.place(x=360,y=160)

        #
        addmission_lbl=Label(academic_frame1,text="Addmission :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        current_lbl=Label(academic_frame1,text="Current :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        division_lbl=Label(academic_frame1,text="Division :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        roll_no_lbl=Label(academic_frame1,text="Roll No :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        inactive_reason_lbl=Label(academic_frame1,text="InActive Reason :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        academic_frame2=Frame(MAIN_FRAME_0,height=461,width=560,bg="lightgrey",borderwidth=4,relief=RIDGE)
        academic_frame2.place(x=561,y=0)
        left_reason_lbl=Label(academic_frame2,text="Left Reason :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        out_of_lbl=Label(academic_frame2,text="Out Of :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        lc_lbl=Label(academic_frame2,text="LC Book/No/Date :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        lc_remark_lbl=Label(academic_frame2,text="LC Remark :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
        ...
        lc_copy_lbl=Label(academic_frame2,text="LC Copy :",padx=5,pady=5,font=("Arieal",10,"bold"),bg="lightgrey")
    ...
    def other_details():
        ...
        gr_details_BTN["state"]="disabled"
        #
        Gr_label = Label(MAIN_FRAME_0, text="GR NO : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Name_label = Label(MAIN_FRAME_0, text="Name : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Bank_holder=Label(MAIN_FRAME_0, text="Bank Acc. Holder : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Scholarship_label = Label(MAIN_FRAME_0, text="Scholarship Category : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Transport_label = Label(MAIN_FRAME_0, text="Transport : ", font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey" )
        ...
        #
        bnk_name_label = Label(MAIN_FRAME_0, text="Bank Name : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        preschool_label=Label(MAIN_FRAME_0,text='PreSchool Type : ',font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        blood_label = Label(MAIN_FRAME_0, text="Blood Group : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        bank_acc_no_label = Label(MAIN_FRAME_0, text="Bank Account No : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Remark_label = Label(MAIN_FRAME_0, text="Remark : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        bank_branch_label = Label(MAIN_FRAME_0, text="Bank Branch : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        student_email_label = Label(MAIN_FRAME_0, text="Student Email : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        IFSC_label = Label(MAIN_FRAME_0, text="IFSC Code : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Mobile_No_label = Label(MAIN_FRAME_0, text="Mobile No. : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        SUID_label = Label(MAIN_FRAME_0, text="SUID : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Adhar_no_label = Label(MAIN_FRAME_0, text="Adhar Card No : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        present_address_frame = LabelFrame(MAIN_FRAME_0, bg="lightgrey", text="Present Address", width=980, height=220,relief=RIDGE)
        present_address_frame.place(x=10, y=235)

        #
        Address_label = Label(present_address_frame, text="Address : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        Area_label = Label(present_address_frame, text="Area : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        City_label = Label(present_address_frame, text="City : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        #
        District_label = Label(present_address_frame, text="District : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        Pincode_label = Label(present_address_frame, text="Pincode : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
        ...
        Phone_label = Label(present_address_frame, text="Phone No : ",font=('Monteserrat', 10, 'bold'), fg="black", bg="lightgrey")
    ...
    def gr_details1():
        ...
        details_frame=Frame(MAIN_FRAME_0,height=150,width=920,bg="lightgrey",borderwidth=4,relief=RIDGE)
        details_frame.place(x=170,y=20)

        
        general_details_frame=Frame(MAIN_FRAME_0,height=280,width=820,bg="lightgrey",borderwidth=4,relief=RIDGE)
        general_details_frame.place(x=170,y=175)

        gr_lbl=Label(details_frame,text="GR no :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        form_no_lbl=Label(details_frame,text="Form No :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        enquiry_no_lbl=Label(details_frame,text="Enquiry No :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        uid_lbl=Label(details_frame,text="UID :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        name1_lbl=Label(details_frame,text="Name :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        name1_lbl.place(x=25,y=100)


        surname_lbl=Label(details_frame,text="Surname:",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        name_lbl=Label(details_frame,text="Name:",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        father_lbl=Label(details_frame,text="Father:",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        mother_lbl=Label(details_frame,text="Mother:",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        sex_lbl=Label(general_details_frame,text="Sex :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        birth_date_lbl=Label(general_details_frame,text="Birth Date :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        category_lbl=Label(general_details_frame,text="Category :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        birth_place_lbl=Label(general_details_frame,text="Birth Place :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        previous_school_lbl=Label(general_details_frame,text="Previous School :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        caste_lbl=Label(general_details_frame,text="Caste :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        birth_taluka_lbl=Label(general_details_frame,text="Birth Taluka :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        subcaste_lbl=Label(general_details_frame,text="Subcaste :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
        ...
        state_lbl=Label(general_details_frame,text="State :",padx=5,pady=5,bg="lightgrey",font=("Arial",10,"bold"))
    ...
    def gr_delete1():
        ...
        Gr_label_delete = Label(MAIN_FRAME_0, text="GR NO : ", font=('Monteserrat', 20, 'bold'), fg="black", bg="lightgrey")
...
def FEES_FUNCTION(DatabaseName):
    ...
    wrapper1=Frame(MAIN_FRAME,height=400,width=820)
    wrapper1.place(x=50,y=140)
    style = ttk.Style()
    style.theme_use('clam')
    style.configure("Treeview", rowheight=35)
    style.configure("Treeview", font=("Arial", 12))  # Change font size here
    ...
    def fees_search(e):
        ...
        style = ttk.Style()
        style.configure("Treeview", font=("Arial", 12))  # Change font size here
        style.configure("Treeview.Heading", font=("Arial", 12))  # Change font size for column headings

        treeview = ttk.Treeview(tree_frame, yscrollcommand=scrollbary.set, columns=("GR No", "Name", "Surname", "Standard", "Division", "Roll No"), show='headings', height=40)
    ...
    def stdwise_fee_change():
        ...
        class TableApp:
            ...
            def create_table(self):
                ...
                # Get column names using SHOW COLUMNS query
                ...
                self.cursor.execute(f"SELECT * FROM academic_detail")
                acadata = self.cursor.fetchall()
                

                self.cursor.execute(f"SELECT * FROM pending_fee_detail")
                penddata = self.cursor.fetchall()
                ...
                # Create Entry widgets for each cell in a grid
                for col_index, column_name in enumerate(columns):
                    heading_label = tk.Label(frame, text=column_name, font=('bold',15),bg="lightpink")
                    heading_label.grid(row=0, column=col_index, padx=10, pady=10)
            ...
            def save_changes(self):
                ...
                try:
                    for (row, col), entry_widget in self.entry_widgets.items():
                        ...
                        primary_key = self.entry_widgets[(row, 0)].get() 
                        column_name = self.get_column_name(col)
                        update_query = f"UPDATE {self.table_name} SET {column_name} = %s WHERE {self.get_column_name(0)} = %s"
                        self.cursor.execute(update_query, (new_value, primary_key))
                        self.db.commit()
    ...
    FEES_DEPT_LABEL = Label(MAIN_FRAME, text="DEPT : ", font=('Arial', 12), bg="lightpink")
    FEES_DEPT_LABEL.place(x=50, y=10)

    FEES_DEPT_ENTRY = Entry(MAIN_FRAME, width=17, font=('Arial', 12))
    FEES_DEPT_ENTRY.place(x=120, y=10)

    FEES_GR_LABEL = Label(MAIN_FRAME, text="GR : ", font=('Arial', 12), bg="lightpink")
    FEES_GR_LABEL.place(x=300, y=10)

    FEES_GR_ENTRY = Entry(MAIN_FRAME, width=17, font=('Arial', 12))
    FEES_GR_ENTRY.place(x=370, y=10)
    FEES_GR_ENTRY.bind('<F3>', fees_search)

    FEES_DATE_LABEL = Label(MAIN_FRAME, text="DATE : ", font=('Arial', 12), bg="lightpink")
    FEES_DATE_LABEL.place(x=550, y=10)

    FEES_DATE_ENTRY = DateEntry(MAIN_FRAME, selectmode="day", date_pattern="dd-mm-y", width=15, font=('Arial', 12))
    FEES_DATE_ENTRY.place(x=620, y=10)

    FEES_RECEIPTNO_LABEL = Label(MAIN_FRAME, text="RECEIPT NO. : ", font=('Arial', 12), bg="lightpink")
    FEES_RECEIPTNO_LABEL.place(x=800, y=10)

    FEES_RECEIPTNO_ENTRY = Entry(MAIN_FRAME, width=17, font=('Arial', 12))
    FEES_RECEIPTNO_ENTRY.place(x=930, y=10)


    FEES_NAME_LABEL=Label(MAIN_FRAME,text="NAME : ",font=('Arial', 12),bg="lightpink")
    FEES_NAME_LABEL.place(x=50,y=45)
    FEES_NAME_ENTRY=Entry(MAIN_FRAME,width=48, font=('Arial', 12))
    FEES_NAME_ENTRY.place(x=120,y=45)


    FEES_RECEIPTBOOK_LABEL=Label(MAIN_FRAME,text="RECEIPT BOOK : ",font=('Arial', 12),bg="lightpink")
    FEES_RECEIPTBOOK_LABEL.place(x=780,y=45)
    FEES_RECEIPTBOOK_ENTRY=Entry(MAIN_FRAME,width=17,font=('Arial', 12))
    FEES_RECEIPTBOOK_ENTRY.place(x=930,y=45)
    FEES_RECEIPTBOOK_ENTRY.delete(0,END)
    FEES_RECEIPTBOOK_ENTRY.insert(0,"ARPT")


    FEES_STD_LABEL=Label(MAIN_FRAME,text="STD : ",font=('Arial', 12),bg="lightpink")
    FEES_STD_LABEL.place(x=50,y=85)
    FEES_STD_ENTRY=Entry(MAIN_FRAME,width=17,font=('Arial', 12))
    FEES_STD_ENTRY.place(x=120,y=85)


    FEES_DIV_LABEL=Label(MAIN_FRAME,text="DIV : ",font=('Arial', 12),bg="lightpink")
    FEES_DIV_LABEL.place(x=300,y=85)
    FEES_DIV_ENTRY=Entry(MAIN_FRAME,width=17,font=('Arial', 12))
    FEES_DIV_ENTRY.place(x=370,y=85)


    GAP = 75
    FEES_TOTALAMOUNT_LABEL=Label(MAIN_FRAME,text="TOTAL : ",font=('Arial', 12),bg="lightpink")
    FEES_TOTALAMOUNT_LABEL.place(x=80,y=600)
    FEES_TOTALAMOUNT_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_TOTALAMOUNT_ENTRY.place(x=50,y=620)

    FEES_LATEFEES_LABEL=Label(MAIN_FRAME,text="LATE FEES : ",font=('Arial', 12),bg="lightpink")
    FEES_LATEFEES_LABEL.place(x=430 - GAP, y=600)
    FEES_LATEFEES_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_LATEFEES_ENTRY.place(x=400 - GAP,y=620)
    FEES_LATEFEES_ENTRY.insert(0,0)


    EXEMPTION_LABEL=Label(MAIN_FRAME,text="EXEMPTION : ",font=('Arial', 12),bg="lightpink")
    EXEMPTION_LABEL.place(x=730 - GAP,y=600)
    EXEMPTION_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    EXEMPTION_ENTRY.place(x=700 - GAP,y=620)
    EXEMPTION_ENTRY.insert(0,0)

    
    FEES_GRANDTOTAL_LABEL=Label(MAIN_FRAME,text="GRAND TOTAL : ",font=('Arial', 12),bg="lightpink")
    FEES_GRANDTOTAL_LABEL.place(x=1030 - GAP,y=600)
    FEES_GRANDTOTAL_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_GRANDTOTAL_ENTRY.place(x=1000 - GAP,y=620)
    ...
    FEES_PAYMODE_LABEL=Label(MAIN_FRAME,text="PAYMODE : ",font=('Arial', 12),bg="lightpink")
    FEES_PAYMODE_LABEL.place(x=80,y=500)
    FEES_PAYMODE_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_PAYMODE_ENTRY.place(x=50,y=520)

    FEES_BANKNAME_LABEL=Label(MAIN_FRAME,text="BANK : ",font=('Arial', 12),bg="lightpink")
    FEES_BANKNAME_LABEL.place(x=430 - GAP,y=500)
    FEES_BANKNAME_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_BANKNAME_ENTRY.place(x=400 - GAP,y=520)

    FEES_CHEQUENUMBER_LABEL=Label(MAIN_FRAME,text="CHEQUENO : ",font=('Arial', 12),bg="lightpink")
    FEES_CHEQUENUMBER_LABEL.place(x=730 - GAP,y=500)
    FEES_CHEQUENUMBER_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_CHEQUENUMBER_ENTRY.place(x=700 - GAP,y=520)

    FEES_CHEQUEDATE_LABEL=Label(MAIN_FRAME,text="CHEQUEDATE : ",font=('Arial', 12),bg="lightpink")
    FEES_CHEQUEDATE_LABEL.place(x=1030 - GAP,y=500)
    FEES_CHEQUEDATE_ENTRY=Entry(MAIN_FRAME,width=20,font=('Arial', 13))
    FEES_CHEQUEDATE_ENTRY.place(x=1000 - GAP,y=520)
    ...
    def fees_generate():
        ...
        if (CheckVar1.get() == 1):
            if(gr_checks[0][1] == 1):
                ...
                trv.insert(parent='',index="end",text='',value=("APR TO JUN TUITION",pending_data[0][3],exmp_data[0][3],pending_data[0][3]-exmp_data[0][3]))
                if pending_data[0][4]-exmp_data[0][4] > 0:
                    trv.insert(parent='',index="end",text='',value=("APR TO JUN ACTIVITY",pending_data[0][4],exmp_data[0][4],pending_data[0][4]-exmp_data[0][4]))
                else:
                    pass
        if (CheckVar2.get() == 1):
            if(gr_checks[0][2] == 1):
                ...
                trv.insert(parent='',index="end",text='',value=("JUL TO SEP TUITION",pending_data[0][6],exmp_data[0][6],pending_data[0][6]-exmp_data[0][6]))
                if pending_data[0][7]-exmp_data[0][7] > 0:
                    trv.insert(parent='',index="end",text='',value=("JUL TO SEP ACTIVITY",pending_data[0][7],exmp_data[0][7],pending_data[0][7]-exmp_data[0][7]))
                else:
                    pass
        if (CheckVar3.get() == 1):
            if(gr_checks[0][3] == 1):
        ...
        if (CheckVar6.get() == 1):
            if(gr_checks[0][6] == 1):
                ...
                trv.insert(parent='',index="end",text='',value=("ADMISSION FEE",pending_data[0][1],exmp_data[0][1],pending_data[0][1]-exmp_data[0][1]))
        if (CheckVar7.get() == 1):
            if(gr_checks[0][7] == 1):
                pass
            else:
    ...
    def show_fee_details_func():
        ...
        def save_data():
            ...
            gr_details.surname, academic_detail.aai1
            ...
            if left_aai_value:
                where_clauses.append(f"academic_detail.aai1 LIKE '{left_aai_value}%'")
        ...
        gr_no_label = tk.Label(left_frame, text="GR_No:", bg="lightpink", font=("Arial", 18))
        gr_no_label.grid(row=0, column=0, padx=10, pady=10, sticky=tk.E)

        gr_no_var = tk.StringVar()
        gr_no_entry = tk.Entry(left_frame, textvariable=gr_no_var, font=("Arial", 18))
        gr_no_entry.grid(row=0, column=1, padx=10, pady=10)

        left_std_label = tk.Label(left_frame, text="Standard:", bg="lightpink", font=("Arial", 18))
        ...
        left_std_dropdown.config(font=("Arial", 18))
        left_std_dropdown.grid(row=1, column=1, padx=10, pady=10)

        left_div_label = tk.Label(left_frame, text="Division:", bg="lightpink", font=("Arial", 18))
        left_div_label.grid(row=2, column=0, padx=10, pady=10, sticky=tk.E)
        ...
        left_div_dropdown.config(font=("Arial", 18))
        left_div_dropdown.grid(row=2, column=1, padx=10, pady=10)

        left_name_label = tk.Label(left_frame, text="Name:", bg="lightpink", font=("Arial", 18))
        left_name_label.grid(row=3, column=0, padx=10, pady=10, sticky=tk.E)

        left_name_entry = tk.Entry(left_frame, font=("Arial", 18))
        left_name_entry.grid(row=3, column=1, padx=10, pady=10)

        left_father_name_label = tk.Label(left_frame, text="Father Name:", bg="lightpink", font=("Arial", 18))
        left_father_name_label.grid(row=4, column=0, padx=10, pady=10, sticky=tk.E)

        left_father_name_entry = tk.Entry(left_frame, font=("Arial", 18))
        left_father_name_entry.grid(row=4, column=1, padx=10, pady=10)

        left_surname_label = tk.Label(left_frame, text="Surname:", bg="lightpink", font=("Arial", 18))
        left_surname_label.grid(row=5, column=0, padx=10, pady=10, sticky=tk.E)

        left_surname_entry = tk.Entry(left_frame, font=("Arial", 18))
        left_surname_entry.grid(row=5, column=1, padx=10, pady=10)

        left_aai_var = tk.BooleanVar()
        left_aai_checkbox = tk.Checkbutton(left_frame, text="AAI", variable=left_aai_var, bg="lightpink", font=("Arial", 18))
        left_aai_checkbox.grid(row=6, column=0, padx=10, pady=10, sticky=tk.W)

        save_button = tk.Button(left_frame, text="Generate", command=save_data, font=("Arial", 18))
        save_button.grid(row=7, column=0, columnspan=2, padx=10, pady=10)


        right_frame = tk.Frame(root, bg="lightpink")
        right_frame.grid(row=0, column=1, padx=10, pady=10)

        right_std_label = tk.Label(right_frame, text="Right Screen - Standard:", bg="lightpink", font=("Arial", 18))
        right_std_label.grid(row=0, column=0, padx=10, pady=10, sticky=tk.E)
        ...
        right_div_label = tk.Label(right_frame, text="Right Screen - Division:", bg="lightpink", font=("Arial", 18))
        right_div_label.grid(row=1, column=0, padx=10, pady=10, sticky=tk.E)
        ...
        right_div_dropdown.config(font=("Arial", 18))
        right_div_dropdown.grid(row=1, column=1, padx=10, pady=10)

        right_aai_var = tk.BooleanVar()
        right_aai_checkbox = tk.Checkbutton(right_frame, text="Right Screen - AAI", variable=right_aai_var, bg="lightpink", font=("Arial", 18))
        right_aai_checkbox.grid(row=2, column=0, padx=10, pady=10, sticky=tk.W)
        ...
        select_all_button = tk.Button(right_frame, text="Select All", command=select_all_items, font=("Arial", 18))
        select_all_button.grid(row=4, column=0, columnspan=1, padx=10, pady=10)
        ...
        clear_button = tk.Button(right_frame, text="Clear Data", command=clear_data, font=("Arial", 18))
        ...
        def save_data1():
            ...
            for selected_item in selected_items:
                ...
                aai = right_aai_var.get()

                update_query = """
                UPDATE academic_detail
                SET curr_std = %s, division = %s, aai1 = %s
                WHERE gr_no = %s
                """
                update_data = (std, div, aai, gr_no)
        ...
        save_button = tk.Button(right_frame, text="Save", command=save_data1, font=("Arial", 18))
        save_button.grid(row=4, column=2, columnspan=2, padx=10, pady=10)



        columns = ("GR_No", "Std", "Div", "Name", "FatherName", "Surname", "AAI")
        table = ttk.Treeview(root, columns=columns, show="headings", height=20, selectmode="extended")
        ...
        checkbox_image = tk.PhotoImage(width=18, height=18)
        checkbox_image.put(("black",), to=(2, 2, 15, 15))
        checkbox_image.put(("white",), to=(4, 4, 13, 13))
        checkbox_image.put(("black",), to=(6, 6, 11, 11))

        left_choose_var = tk.BooleanVar()
        table.tag_configure("Checkbox", image=checkbox_image, background="lightpink")
    ...
    GENERATE_BTN.place(x=1150,y=700)
