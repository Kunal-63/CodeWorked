...
cur.execute("create table if not exists bonafide(no int primary key, name varchar(50), father_name varchar(50), surname varchar(50), curr_std varchar(50), curr_year int, curr_date varchar(50), curr_year varchar(50),gr_no varchar(50),BIRTH_DATE VARCHAR(50),BIRTH_DATE_in_words varchar(50),address1 varchar(50),address2 varchar(50))")

cur.execute("create table if not exists exmp_fees(std varchar(15),ADMISSION_FEE INT,ICARD INT,APR_JUN_TUTION INT,APR_JUN_ATITVITY, LATE_FEES INT,JUL_SEP_TUTION INT,JUL_SEP_ACTIVITY INT,OCT_DEC_TUTION INT,OCT_DEC_ACTIVITY INT,JAN_MAR_TUTION INT,JAN_MAR_ACTIVITY INT,OTHERS1 INT)")
...
cur.execute("create table if not exists other_detail(gr_no int primary key, name varchar(255),bnk_ac_holder varchar(50),scholar_cat varchar(50),transport varchar(50),bnk_name varchar(50),presch_type varchar(50),blood_grp varchar(50),bnk_ac_name varchar(50),remark varchar(50),bnk_branch varchar(50),student_email varchar(200),ifsc_code varchar(50),mobile_no varchar(50),suid varchar(50),adhar_cardno varchar(50),address1 varchar(200),address2 varchar(200),area varchar(50),city varchar(50),district varcahr(50),pincode int,phone_no int)")

cur.execute("create table if not exists pending_fee_detail(GR_NO INT PRIMARY KEY, ADMISSION_FEE INT,ICARD INT,APR_JUN_TUTION INT,APR_JUN_ATITVITY, LATE_FEES INT,JUL_SEP_TUTION INT,JUL_SEP_ACTIVITY INT,OCT_DEC_TUTION INT,OCT_DEC_ACTIVITY INT,JAN_MAR_TUTION INT,JAN_MAR_ACTIVITY INT,OTHERS INT)")

cur.execute("create table if not exists std_fees(STD VARCHAR(15),ADMISSION_FEE INT,ICARD INT,APR_JUN_TUTION INT,APR_JUN_ATITVITY, LATE_FEES INT,JUL_SEP_TUTION INT,JUL_SEP_ACTIVITY INT,OCT_DEC_TUTION INT,OCT_DEC_ACTIVITY INT,JAN_MAR_TUTION INT,JAN_MAR_ACTIVITY INT,OTHERS1 INT)")
