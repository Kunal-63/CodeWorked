...
def FEES_REPORT_FUNCTION():
    ...
    cur.execute("select curr_std,division,count(gr_no) as total from academic_detail group by curr_std,division order by curr_std")
    data_report = cur.fetchall()
    for i in data_report:
        wrt.writerow(i)
    f2.close()
    ...
    cur.execute("select academic_detail.curr_std,academic_detail.division,gr_details.sex,count(gr_details.sex) as total from gr_details,academic_detail group by academic_detail.curr_std,academic_detail.division,gr_details.sex order by academic_detail.curr_std,academic_detail.division")
    data_report = cur.fetchall()
    for i in data_report:
        wrt.writerow(i)
    f3.close()
    ...
    cur.execute("select academic_detail.curr_std,academic_detail.division,gr_details.caste,count(gr_details.caste) as total from gr_details,academic_detail group by academic_detail.curr_std,academic_detail.division,gr_details.caste order by academic_detail.curr_std,academic_detail.division")
    data_report = cur.fetchall()    
    for i in data_report:
        wrt.writerow(i)
    f4.close()
    ...
    cur.execute("select gr_details.gr_no,gr_details.name,gr_details.father,gr_details.surname,academic_detail.curr_std,academic_detail.division from gr_details,academic_detail where gr_details.gr_no>4575 and gr_details.gr_no=academic_detail.gr_no")
    data_report = cur.fetchall()    
    for i in data_report:
        wrt.writerow(i)
    f5.close()
